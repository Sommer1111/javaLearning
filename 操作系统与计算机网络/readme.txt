...
三、第三章：确定发送路径————集线器、交换机、路由器
  ...
  交换机：IP地址确定局域网，MAC地址确定局域网中的具体设备。接收过程，当有发给本地局域网内一台主机的数据包时，
        换机接收下来，然后把数据包中的IP地址按照“表”中的对应关系映射成MAC地址，转发到对应的MAC地址的主机上
                                         ...
                                         《操作系统学习篇》
一、翻了一下《现代操作系统》这本大厚书，发现内容繁杂、枯燥而不想看

二、转而去翻阅“码农翻身”公众号与操作系统和网络相关的推文，发现没有相关知识基础看起来并无益处。还是不知道，
因为涉及到各种概念。

三、老老实实看教学视频。
B站对比了一下，选择王道考研讲解的操作系统，开始拘泥于细节。但慢慢觉得里面考研的细节太多，根本没有必要花费
精力去了解。所以大概侧重的看了理解部分。对具体的各种优化算法、计算细节，快速掠过。对操作系统有个大的框架先。
